...
public static class WebAppConfig
{
    ...
    /// <summary>
    /// Gets the Archicad API server URL (defaults to localhost:48882)
    /// </summary>
    public static string GetApiUrl()
    {
        var envApiUrl = Environment.GetEnvironmentVariable("ARCHICAD_API_URL");
        if (!string.IsNullOrEmpty(envApiUrl))
        {
            return envApiUrl;
        }
        
        return "http://localhost:48882";
    }
}
